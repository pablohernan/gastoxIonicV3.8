...
var CurrencyConvert = /** @class */ (function () {
    ...
    */
    CurrencyConvert.prototype.getConvert = function (from, to, callBackFn) {
        this.http.get('https://finance.yahoo.com/webservice/v1/symbols/allcurrencies/quote?format=json').subscribe(function (data) {
            //console.log(data);
            var precioToFrom = '0';
...
//# sourceMappingURL=currency-convert.js.map